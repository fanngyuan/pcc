...
<body>
    <div class="header">
        <div class="container black">
            <div class="qrcode">
                <div class="littlecode">
                    <img width="16px" src="/hgg/img/little_qrcode.jpg" id="licode">
                    <div class="showqrs" id="showqrs">
                        <div class="shtoparrow"></div>
                        <div class="guanzhuqr">
                            <img src="/hgg/img/guanzhu_qrcode.png" width="80">
        ...
        <div class="container">
            <div class="nav">
                <a href="https://www.alipay.com/" class="logo"><img src="/hgg/img/alipay_logo.png" height="30px"></a>
    ...
    <div class="content">
        <form action="alipayapi" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDout_trade_no" id="out_trade_no" value="${out_trade_no}"></div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDsubject" value="${product_name}"></div>
                <br>
                <div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>
            </div>
            <div class="element">
                <div class="etitle">付款金额:</div>
                <div class="einput"><input type="text" name="WIDtotal_fee" value="${price}"></div>
                <br>
                <div class="mark">注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</div>
            </div>
			<div class="element">
                <div class="etitle">商品描述:</div>
                <div class="einput"><input type="text" name="WIDbody" value="${description}"></div>
                <br>
